...
async def get_original_article_links(driver, chromedriver_excute_path=None, save_path="./",
    ...
    for container in containers:
        ...
        for section in sections:
            ...
            if h4_tag and h4_tag.get_text().strip() == 'Articles':
                original_article_container = section
                break
    ...
    article_items = original_article_container.find_all('div', class_='al-article-item-wrap al-normal')
    logger.info(f"找到 {len(article_items)} 篇文章")
    article_links = []
    for item in article_items:
        a_tag = item.find('a', class_='at-articleLink')
        if a_tag and 'href' in a_tag.attrs:
            full_url = 'https://academic.oup.com' + a_tag['href']
...
if __name__ == "__main__":
    save_path = "./"
    issue_url = "https://academic.oup.com/rfs/issue/38/5"
    article_url = "https://academic.oup.com/rfs/article-abstract/38/2/507/7918340"
    ...
    # Get_Web_One(article_url, save_path, chromedriver_excute_path=driver_path)
